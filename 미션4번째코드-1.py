# -*- coding: utf-8 -*-
"""
Created on Mon Feb  7 13:45:04 2022
구글 드라이브 참조
####################
@author: 7조 조장: 전준호님
"""
...
mysql_mine.query_execute('alter table price_info add constraint foreign key(종목코드) references company_info(종목코드);')
mysql_mine.query_execute('ALTER DATABASE investar CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci;')
mysql_mine.query_execute('ALTER TABLE company_info CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;')
